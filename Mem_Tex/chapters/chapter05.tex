...
Continuing with the data, another aspect is that the sample period could be affecting the results, meaning that the model might perform better during certain periods. To test this hypothesis, the model was evaluated on various time periods, particularly on dates when the cryptocurrency market was in a bull state, following the findings of \parencite{mella2024bullbear}. The results for these time periods can be found in Appendix \ref{app: bull-res}.
